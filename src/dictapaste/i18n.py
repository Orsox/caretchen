...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "de": {
        ...
        "settings_audio_device": "Audio-Eingabegerät",
        "settings_audio_refresh": "Aktualisieren",
        "settings_audio_refreshed": "Audio-Geräte aktualisiert.",
        "settings_audio_device_removed": "Ausgewähltes Audio-Gerät ist nicht mehr verfügbar.",
        "settings_audio_refresh_error": "Fehler beim Aktualisieren: ",
        "settings_paste_mode_label": "Einfüge-Modus",
        "settings_paste_mode_ctrl_v": "Strg+V (Kopieren + Einfügen)",
        "settings_paste_mode_copy": "Nur kopieren (nur Zwischenablage)",
        "settings_paste_mode_xdotool": "Xdotool (Linux, mit Fallback)",
        "settings_paste_mode_tooltip": "Wähle, wie Text eingefügt wird.",
        "settings_refine_default": "LLM-Nachbearbeitung standardmäßig aktivieren",
        ...
        "settings_reset_prompt": "Auf Standard zurücksetzen",
        "settings_audio_default": "System-Standard",
        "settings_history": "Diktierverlauf",
        "settings_history_entries": "Einträge: ",
        "settings_history_copy": "Auswahl kopieren",
        "settings_history_clear": "Verlauf löschen",
        "settings_history_empty": "Keine Einträge.",
        ...
        "settings_log_open": "Log-Datei öffnen",
        "settings_log_clear": "Log löschen",
        "settings_log_cleared": "Log gelöscht.",
        ...
        "settings_invalid_prompt": "Ungültiger Prompt",
        "settings_invalid_prompt_hint": "Das Template muss {transcript} enthalten.",
        "settings_clear_history_title": "Verlauf löschen",
        "settings_clear_history_confirm": "Wirklich den gesamten Diktierverlauf löschen?",
        "settings_clear_log_title": "Log löschen",
        "settings_clear_log_confirm": "Wirklich die Log-Datei löschen?",
        "settings_log_open_error": "Konnte Log nicht öffnen: ",
        "settings_log_clear_error": "Konnte Log nicht löschen: ",
